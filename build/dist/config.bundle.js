...
class FSRSConfigManager {
    ...
    async handleAutoTrain() {
        ...
        try {
            ...
            const worker = new Worker(new URL(/* worker import */ __webpack_require__.p + __webpack_require__.u("features_tracker_scheduler_fsrsOptimizer_worker_js"), __webpack_require__.b), { type: undefined });
