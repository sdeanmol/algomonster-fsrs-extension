    ...
    filtered.forEach(mark => {
        ...
        card.innerHTML = `
            ...
            <div class="card-actions">
                <button class="action-btn action-btn-copy" data-text="${escapeHtml(mark.text)}" title="Copy text to clipboard">📋</button>
                <button class="action-btn action-btn-delete" data-id="${markId}" title="Delete Highlight">🗑️</button>
            </div>
        `;
